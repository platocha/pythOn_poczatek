...
class Geolocator:
    def __init__(self):
        self.geolocator = Nominatim(user_agent="geo-test")
...
def run_example():
    src_address = "aleja Grunwaldzka 472B, 80-309 Gdansk"
    dst_address = "aleja Grunwaldzka 10, 80-236 Gdansk"
    ...
    print(f"Dystans z {src_address} do {dst_address} to {src_dst_distance} metrow")
    print(f"Czas potrzebny na przejscie to ok {src_dst_walk_time} minut")
